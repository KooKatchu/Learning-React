...
const Sorcerer = () => {
    const sourcererImg = 'https://static1.thegamerimages.com/wordpress/wp-content/uploads/2019/10/pjimage-40.jpg';
    return (
    <div>
        <img src = {sourcererImg} className = "characterPic" alt = "A Wizard" />
        
        <h1>This is some Sorcerer stuff!</h1>
